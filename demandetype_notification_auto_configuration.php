 ...
 */
    ...
    class demandetype_notification_auto_configurationPage extends Page
    {
    ...
    try
    {
        $Page = new demandetype_notification_auto_configurationPage("demandetype_notification_auto_configuration", "demandetype_notification_auto_configuration.php", GetCurrentUserPermissionsForPage("demandetype_notification_auto_configuration"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("demandetype_notification_auto_configuration"));
