 ...
 */
    ...
    class demandetype_documentfusion_demandetypePage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search');
            ...
            $multi_value_select_editor->SetHandlerName('filter_builder_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('demandetype_demandetype_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Demandetype Demandetype Id', 'demandetype_demandetype_id', 'demandetype_demandetype_id_demandetype_designation', 'edit_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search', $editor, $this->dataset, $lookupDataset, 'demandetype_id', 'demandetype_designation', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('demandetype_documentfusion_designation', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Demandetype Documentfusion Demandetype Documentfusion Id', 'demandetype_documentfusion_demandetype_documentfusion_id', 'demandetype_documentfusion_demandetype_documentfusion_id_demandetype_documentfusion_designation', 'insert_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search', $editor, $this->dataset, $lookupDataset, 'demandetype_documentfusion_id', 'demandetype_documentfusion_designation', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('demandetype_designation', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Demandetype Demandetype Id', 'demandetype_demandetype_id', 'demandetype_demandetype_id_demandetype_designation', 'insert_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search', $editor, $this->dataset, $lookupDataset, 'demandetype_id', 'demandetype_designation', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('demandetype_documentfusion_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search', 'demandetype_documentfusion_id', 'demandetype_documentfusion_designation', null, 20);
            ...
            $lookupDataset->setOrderByField('demandetype_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search', 'demandetype_id', 'demandetype_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demandetype_documentfusion_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search', 'demandetype_documentfusion_id', 'demandetype_documentfusion_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demandetype_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search', 'demandetype_id', 'demandetype_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demandetype_documentfusion_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_demandetype_documentfusion_demandetype_demandetype_documentfusion_demandetype_documentfusion_id_search', 'demandetype_documentfusion_id', 'demandetype_documentfusion_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demandetype_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_demandetype_documentfusion_demandetype_demandetype_demandetype_id_search', 'demandetype_id', 'demandetype_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new demandetype_documentfusion_demandetypePage("demandetype_documentfusion_demandetype", "demandetype_documentfusion_demandetype.php", GetCurrentUserPermissionsForPage("demandetype_documentfusion_demandetype"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("demandetype_documentfusion_demandetype"));
