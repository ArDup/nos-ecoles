 ...
 */
    ...
    class domaineofficiel_utilisateurPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('domaineofficiel_domaineofficiel_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_domaineofficiel_utilisateur_avatar_avatar_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('avatar_avatar_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_domaineofficiel_utilisateur_avatar_avatar_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Domaineofficiel Domaineofficiel Id', 'domaineofficiel_domaineofficiel_id', 'domaineofficiel_domaineofficiel_id_domaineofficiel_designation', 'edit_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', $editor, $this->dataset, $lookupDataset, 'domaineofficiel_id', 'domaineofficiel_designation', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Avatar Avatar Id', 'avatar_avatar_id', 'avatar_avatar_id_avatar_nom', 'edit_domaineofficiel_utilisateur_avatar_avatar_id_search', $editor, $this->dataset, $lookupDataset, 'avatar_id', 'avatar_nom', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Domaineofficiel Domaineofficiel Id', 'domaineofficiel_domaineofficiel_id', 'domaineofficiel_domaineofficiel_id_domaineofficiel_designation', 'multi_edit_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', $editor, $this->dataset, $lookupDataset, 'domaineofficiel_id', 'domaineofficiel_designation', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Avatar Avatar Id', 'avatar_avatar_id', 'avatar_avatar_id_avatar_nom', 'multi_edit_domaineofficiel_utilisateur_avatar_avatar_id_search', $editor, $this->dataset, $lookupDataset, 'avatar_id', 'avatar_nom', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Domaineofficiel Domaineofficiel Id', 'domaineofficiel_domaineofficiel_id', 'domaineofficiel_domaineofficiel_id_domaineofficiel_designation', 'insert_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', $editor, $this->dataset, $lookupDataset, 'domaineofficiel_id', 'domaineofficiel_designation', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Avatar Avatar Id', 'avatar_avatar_id', 'avatar_avatar_id_avatar_nom', 'insert_domaineofficiel_utilisateur_avatar_avatar_id_search', $editor, $this->dataset, $lookupDataset, 'avatar_id', 'avatar_nom', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', 'domaineofficiel_id', 'domaineofficiel_designation', null, 20);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_domaineofficiel_utilisateur_avatar_avatar_id_search', 'avatar_id', 'avatar_nom', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', 'domaineofficiel_id', 'domaineofficiel_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_domaineofficiel_utilisateur_avatar_avatar_id_search', 'avatar_id', 'avatar_nom', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', 'domaineofficiel_id', 'domaineofficiel_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_domaineofficiel_utilisateur_avatar_avatar_id_search', 'avatar_id', 'avatar_nom', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('domaineofficiel_designation', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_domaineofficiel_utilisateur_domaineofficiel_domaineofficiel_id_search', 'domaineofficiel_id', 'domaineofficiel_designation', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('avatar_nom', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_domaineofficiel_utilisateur_avatar_avatar_id_search', 'avatar_id', 'avatar_nom', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class domaineofficielPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Domaineofficiel');
            $this->SetMenuLabel('Domaineofficiel');
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'domaineofficiel_id', 'domaineofficiel_id', 'Domaineofficiel Id'),
                new FilterColumn($this->dataset, 'domaineofficiel_designation', 'domaineofficiel_designation', 'Domaineofficiel Designation')
            );
        }
        ...
        {
            $quickFilter
                ->addColumn($columns['domaineofficiel_id'])
                ->addColumn($columns['domaineofficiel_designation']);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            $main_editor = new TextEdit('domaineofficiel_id_edit');
            
            $filterBuilder->addColumn(
                $columns['domaineofficiel_id'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
            ...
            $main_editor = new TextEdit('domaineofficiel_designation_edit');
            $main_editor->SetMaxLength(45);
            
            $filterBuilder->addColumn(
                $columns['domaineofficiel_designation'],
                array(
                    FilterConditionOperator::EQUALS => $main_editor,
                    FilterConditionOperator::DOES_NOT_EQUAL => $main_editor,
                    FilterConditionOperator::IS_GREATER_THAN => $main_editor,
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('domaineofficiel.utilisateur')->HasViewGrant() && $withDetails)
            {
            //
            // View column for domaineofficiel_utilisateur detail
            //
            $column = new DetailColumn(array('domaineofficiel_id'), 'domaineofficiel.utilisateur', 'domaineofficiel_utilisateur_handler', $this->dataset, 'Utilisateur');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            //
            // View column for domaineofficiel_id field
            //
            $column = new NumberViewColumn('domaineofficiel_id', 'domaineofficiel_id', 'Domaineofficiel Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            // View column for domaineofficiel_designation field
            //
            $column = new TextViewColumn('domaineofficiel_designation', 'domaineofficiel_designation', 'Domaineofficiel Designation', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        {
            //
            // Edit column for domaineofficiel_id field
            //
            $editor = new TextEdit('domaineofficiel_id_edit');
            $editColumn = new CustomEditColumn('Domaineofficiel Id', 'domaineofficiel_id', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for domaineofficiel_designation field
            //
            $editor = new TextEdit('domaineofficiel_designation_edit');
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Domaineofficiel Designation', 'domaineofficiel_designation', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new domaineofficiel_utilisateurPage('domaineofficiel_utilisateur', $this, array('domaineofficiel_domaineofficiel_id'), array('domaineofficiel_id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('domaineofficiel.utilisateur'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('domaineofficiel.utilisateur'));
            $detailPage->SetHttpHandlerName('domaineofficiel_utilisateur_handler');
            $handler = new PageHTTPHandler('domaineofficiel_utilisateur_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new domaineofficielPage("domaineofficiel", "domaineofficiel.php", GetCurrentUserPermissionsForPage("domaineofficiel"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("domaineofficiel"));
