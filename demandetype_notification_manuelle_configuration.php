 ...
 */
    ...
    class demandetype_notification_manuelle_configurationPage extends Page
    {
    ...
    try
    {
        $Page = new demandetype_notification_manuelle_configurationPage("demandetype_notification_manuelle_configuration", "demandetype_notification_manuelle_configuration.php", GetCurrentUserPermissionsForPage("demandetype_notification_manuelle_configuration"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("demandetype_notification_manuelle_configuration"));
