 ...
 */
    ...
    class v_ecolesPage extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'TYPE_CONCTRUCTIF', 'TYPE_CONCTRUCTIF', 'TYPE CONCTRUCTIF'),
                ...
                new FilterColumn($this->dataset, 'NB_ELEVE_CLASSE', 'NB_ELEVE_CLASSE', 'NB ELEVE CLASSE'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('TYPE_CONCTRUCTIF', 'TYPE_CONCTRUCTIF', 'TYPE CONCTRUCTIF', $this->dataset);
            $column->SetOrderable(true);
            $column->setBold(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
        ...
        protected function doGetCustomFormLayout($mode, FixedKeysArray $columns, FormLayout $layout)
        {
            if ($mode=='insert' or $mode=='edit' or $mode=='view') {                     
              ...
              $layout->enableTabs(FormTabsStyle::TABS);                
                ...
                $descriptionGroup->addRow()->addCol($columns['telephone'], 4, 2) ->addCol($columns['nombre_d_eleves'], 4, 2) ;
    ...
    try
    {
        $Page = new v_ecolesPage("v_ecoles", "v_ecoles.php", GetCurrentUserPermissionsForPage("v_ecoles"), 'UTF-8');
