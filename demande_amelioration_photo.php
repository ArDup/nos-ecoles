 ...
 */
    ...
    class demande_amelioration_photoPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_demande_amelioration_photo_demande_amelioration_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('demande_amelioration_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_demande_amelioration_photo_demande_amelioration_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Demande Amelioration Id', 'demande_amelioration_id', 'demande_amelioration_id_demande_objet', 'edit_demande_amelioration_photo_demande_amelioration_id_search', $editor, $this->dataset, $lookupDataset, 'demande_id', 'demande_objet', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Demande Amelioration Id', 'demande_amelioration_id', 'demande_amelioration_id_demande_objet', 'multi_edit_demande_amelioration_photo_demande_amelioration_id_search', $editor, $this->dataset, $lookupDataset, 'demande_id', 'demande_objet', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Demande Amelioration Id', 'demande_amelioration_id', 'demande_amelioration_id_demande_objet', 'insert_demande_amelioration_photo_demande_amelioration_id_search', $editor, $this->dataset, $lookupDataset, 'demande_id', 'demande_objet', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_demande_amelioration_photo_demande_amelioration_id_search', 'demande_id', 'demande_objet', null, 20);
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_demande_amelioration_photo_demande_amelioration_id_search', 'demande_id', 'demande_objet', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_demande_amelioration_photo_demande_amelioration_id_search', 'demande_id', 'demande_objet', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('demande_objet', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_demande_amelioration_photo_demande_amelioration_id_search', 'demande_id', 'demande_objet', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new demande_amelioration_photoPage("demande_amelioration_photo", "demande_amelioration_photo.php", GetCurrentUserPermissionsForPage("demande_amelioration_photo"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("demande_amelioration_photo"));
